<div class="modal-dialog" role="document">
	<div class="modal-content">
        ...
        <div class="modal-footer d-ib">
            ...
            <button type="button" class="btn btn-danger m-btn--icon m-btn--pill float-right" id="deleteSupport"
...
<script>
    $('#deleteSupport').on('click', function (e) {
        var request = {
            url: '/support/destroySupport/{{$support->id}}',
            method: 'post',
        };

        ajaxRequest(request, function (response) {
            routes.executeRoute('support', {
                url: 'support'
            });
