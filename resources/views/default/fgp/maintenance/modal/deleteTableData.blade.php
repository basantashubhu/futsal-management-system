	...
	<div class="modal-content">
        ...
        <div class="modal-header" style="background-color: #fff !important; border-color: #fff !important;">
            <h5 class="modal-title" id="exampleModalLabel" style="color: #3f4047 !important;">
                <span>Are you sure want to delete this table data?</span>
            </h5>
        ...
        <div class="modal-footer d-ib">
            ...
            <button type="button" class="btn btn-danger m-btn--icon m-btn--pill float-right" id="deletetabledata"
...
<script>
    $('#deletetabledata').on('click', function (e) {
        var request = {
            url: '/deleteTableData/{{$table}}/{{$id}}',
            method: 'post',
        };
