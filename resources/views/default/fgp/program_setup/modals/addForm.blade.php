    ...
    <div class="modal-content">
        ...
        <div class="modal-header">
            <h5 class="modal-title fs-modal-header">
                ...
                <span>Add New Program Details</span>
            </h5>
                    ...
                    <div class="m-portlet__body px-0" style="background: #eee;">
                        <div class="row">
                            <div class="col-sm-12 col-md-6 col-lg-6 field mb-3">
                                ...
                                <input type="text" name="property" id="propertyName" class="form-control">
                            </div>
                            <div class="col-sm-12 col-md-6 col-lg-6 field mb-3">
                                <label for="propertyValue">Value</label>
                                <input type="text" name="value" id="propertyValue" class="form-control">
                            </div>
                            <div class="col-sm-12 col-md-12 col-lg-12 field">
                                <label for="propertyValue2">Value 2</label>
                                <textarea name="value2" id="propertyValue2" class="form-control" rows="5"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    $(function (inputs) {
        ...
        $('#saveProperty').off('click').on('click', function () {
            ...
            sendAjax({
                url: '/program/properties/save-new', method: 'post',
                data, loader: true
            }, function (response) {
                processModal();
