                                            ...
                                            <table style="width: 100%;">
                                                        ...
                                                        <h6>
                                                            <span class="m-widget24__desc ts-value-color">
                                                                @php
                                                                    ...
                                                                    $volunteer = \App\Models\Fgp\Volunteer::find($vol['id'])

                                                                @endphp
                                                                {{$volunteer->etoBalance($timesheet->pay_period->id)?:'00:00'}}
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h6>
                                                            <span class="m-widget24__desc ts-value-color">
                                                                {{$volunteer->total_hrs($timesheet->pay_period->id)}}
                                                            </span>
                                                        </h6>
                                                    </td>
                                                </tr>
    ...
    <div class="m-portlet">
        <div class="m-portlet__body pd-10-i">
            ...
            <div class="ml-auto m-b-10" style="display: flex; justify-content: flex-end;">
                <button class="btn btn-default m-btn btn-sm m-btn--custom m-btn--icon m-btn--pill editable-cal-site-ts" style="margin-right: 7px"><i class="la la-refresh"></i>&nbsp;Edit</button>
                <button class="btn btn-default m-btn btn-sm m-btn--custom m-btn--icon m-btn--pill clear-cal-site-ts" style="margin-right: 7px"><i class="la la-refresh"></i>&nbsp;Clear</button>                
                <button class="btn btn-success m-btn btn-sm m-btn--custom m-btn--icon m-btn--pill save-cal-site-ts" 
