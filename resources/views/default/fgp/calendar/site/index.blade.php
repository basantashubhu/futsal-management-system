    ...
    <div class="m-portlet site_add_form" style="background: #f2f3f8 !important;">
        <div class="m-portlet__body pd-t-10-i">     
            ...
            <div class="row p-0">                    
                <div class="col-sm-12 col-md-3 col-lg-3 no-left-pad">
                    ...
                    <div class="m-portlet pd-10">
                        <ul class="nav nav-tabs  m-tabs-line m-tabs-line--2x m-tabs-line--danger no-m-bottom" role="tablist">     
                          ...
                          >
                            <a class="nav-link m-tabs__link active" data-toggle="tab" href="#calendar-sites-vol" role="tab" style="height: 100%;">
                              Volunteers
                            </a>
                          </li>     
                        ...
                        <div class="tab-content ts-panel-tab-content" id="calendar-sites-vol">
                            <div class="tab-pane active">                                

                                <ul>
                                    @forelse($assignedVolunteers as $assVol)
                                        <li @if($loop->index === 0) class="calendar-sites-active" @endif
                                        data-period-id="{{ $period_id }}"
                                        data-site-id="{{ $site->id }}"
                                        data-vol-id="{{ $assVol['id'] }}"
                                        data-date="{{ $date }}"
                                        >
                                            {{  $assVol['middle_name'] ? join(' ', [$assVol['first_name'], $assVol['last_name']]) : join(" ".$assVol['middle_name']." ", [$assVol['first_name'], $assVol['last_name']]) }}
                                        </li>
                                    @empty
                                    @endforelse
                                </ul>
               ...
               <div class="col-sm-12 col-md-9 col-lg-9" id="calendar-site-right-sec">
                   
                    @include('default.fgp.calendar.site.right-section')
...
@include('default.fgp.calendar.site._js')    
...
<style>
   ...
   .site-vol-list-li ul li{
    ...
    #calendar-sites-vol ul li:hover{
        background-color: #f9f9f9;
        transition: all 300ms ease-in-out;
        cursor: pointer;
    }

    .calendar-sites-active{
        background: #dc3545 !important;
        color: white;
        transition: all 600ms ease-in-out;
    }
