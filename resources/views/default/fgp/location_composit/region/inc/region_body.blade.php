<div class="m-content">
    <div class="m-portlet m-portlet--mobile with-border">
        <div class="m-portlet__body">
                            ...
                            <div class="m-form m-form--label-align-right">
                                <div class="form-group m-form__group row justify-content-start align-items-center toolbar justify-content-start">
                                    ...
                                    <form class="form form-inline" id="stipendFilter">
                                       ...
                                       <div class="col-auto">
                                        <button title="Reset Search" data-route="location/region" class="btn btn-sm btn-outline-primary  m-btn m-btn--outline-2x m-btn--icon m-btn--icon-only m-btn--pill">
            ...
            <!--end: Search Form -->
            <!--begin: Datatable -->
            <div class="m_datatable m-t-20" id="location_region_data_table"></div>
            <!--end: Datatable -->
        </div>
    </div>
</div>