                                        ...
                                        <div class="col-auto">
                                            <div class="m-form__group m-form__group--inline w-220 pill-style">
                                                ...
                                                <div class="m-form__control custom-selecter-btn">
                                                    <input type="text" class="form-control form-control-sm btn-redius" name="state_name" id="stateName">
                                                </div>
                                            </div>
...
{{--                                        </div>--}}
                                    ...
                                    <div class="col-auto">
                                        <button title="Reset Search" data-route="location/state" class="btn btn-sm btn-outline-primary  m-btn m-btn--outline-2x m-btn--icon m-btn--icon-only m-btn--pill">
...
{{--                                                    <button class="c-p dropdown-item stateExporter" data-sort-field="site_name" data-sort-value="desc" data-export-type="csv">--}}
{{--                                                        CSV--}}
{{--                                                    </button>--}}
{{--                                                    <button class="c-p dropdown-item siteExporter" data-sort-field="site_name" data-sort-value="desc" data-export-type="json">--}}
{{--                                                        JSON--}}
{{--                                                    </button>--}}
{{--                                                    <button class="c-p dropdown-item siteExporter" data-sort-field="site_name" data-sort-value="desc" data-export-type="pdf">--}}
{{--                                                        PDF--}}
{{--                                                    </button>--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
...
{{--                                    </div>--}}
            ...
            <!--end: Search Form -->
            <!--begin: Datatable -->
            <div class="m_datatable m-t-20" id="location_state_data_table"></div>
            <!--end: Datatable -->
        </div>
    </div>
</div>