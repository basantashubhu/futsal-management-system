<div class="modal-dialog modal-custom-small-width" role="document">
    <div class="modal-content mp0">
        ...
        <div class="modal-body mp0">
            <form class="m-form m-form--label-align-right floatLabelForm" id="newStateCreate">
                <!--begin::Form-->
        ...
        <div class="modal-footer d-ib">
            ...
            <button type="button" class="float-right btn btn-info m-btn--pill" id="saveNewState" data-target="newStateCreate">
                Save
            </button>
        </div>
    </div>
...
$(function(){
    ...
    /*-------- submit form ----------*/
    $(document).off('click','#saveNewState').on('click','#saveNewState', function (e) {
        var form = $(this).attr('data-target');
        var request = {
            url: '/location/state/store',
            method: 'post',
            form: form
        };
        addFormLoader();
