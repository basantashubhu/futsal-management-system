...
<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <div class="modal-footer" style="display: inline-block; background: #eee;">
            ...
            <button type="button" class="btn btn-danger m-btn--icon m-btn--pill float-right" id="btnDeleteCounty"
...
$(function(){
    ...
    $(document).off('click','#btnDeleteCounty').on('click','#btnDeleteCounty', function (e) {
        e.preventDefault();
        var form = $(this).attr('data-target');
        var request = {
            url: '/location/county/delete',
            method: 'post',
            form: form
        };
