<div class="modal-dialog modal-custom-medium-width" role="document">
    <div class="modal-content">
            ...
            <form id="templateCreate" class="m-form m-form--label-align-right m-form--group-seperator-dashed" enctype="multipart/form-data">
                ...
                <div class="form-group m-form__group row">
                    <div class="col-lg-12">
                        ...
                        <input type="text" class="form-control m-input" id="to" name="to" autocomplete="off" value="">
                    </div>
                </div>
                <div class="form-group m-form__group row">
                    <div class="col-lg-12">
                ...
                <div class="form-group m-form__group row">
                    <div class="col-sm-3" style="padding: 0px">
                        <div class="my-form">
                            ...
                            <input type="file" class="form-control hidden" id="myFile">
                        </div>
                    </div>
                </div>
                <div class="form-group m-form__group row">
        ...
        <div class="modal-footer d-ib">
            <button type="button" class="btn btn-secondary m-btn--pill float-left" id="loadForm" data-sub-modal-route="loadSaveEmail?table=all" data-modal-callback="true">
                Load
            </button>
