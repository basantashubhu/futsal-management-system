<div class="col-xl-9 col-lg-8">
    <div class="m-portlet m-portlet--full-height m-portlet--tabs  ">
        <div class="m-portlet__head">
            <div class="m-portlet__head-tools">
                <ul class="nav nav-tabs m-tabs m-tabs-line   m-tabs-line--left m-tabs-line--primary" role="tablist">
                    ...
                    <li class="nav-item m-tabs__item">
                        <a class="nav-link m-tabs__link" data-toggle="tab" href="#user_control"
                           role="tab">
                            <i class="flaticon-share m--hide"></i>
                            User Control
                        </a>
        ...
        <div class="tab-content">
            @include('default.pages.profile.includes.update_profile')
            @include('default.pages.profile.includes.user_control')
            @include('default.pages.profile.includes.change_password')
            @include('default.pages.profile.includes.signature')
            @include('default.pages.profile.includes.activity')
            @include('default.pages.profile.includes.message')
            @include('default.pages.profile.includes.settings')
            @include('default.pages.profile.includes.layout_builder')
            @include('default.pages.profile.includes.emailSettings')
        </div>
    </div>
</div>
<script>
