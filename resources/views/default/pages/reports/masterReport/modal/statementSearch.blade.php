<div class="modal-dialog modal-lg" role="document">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body has-divider">
            <form id="statement" class="m-form m-form--label-align-right m-form--group-seperator-dashed">
        ...
        <div class="modal-footer d-ib">
            ...
            <button data-sub-modal-route="reports/template/loadView?section=statement" type="button"
...
<script>
    ...
    $('#generateReport').off('click').on('click', function () {
        ...
        var request = {
            url: '/generate/statementReport/'+format,
