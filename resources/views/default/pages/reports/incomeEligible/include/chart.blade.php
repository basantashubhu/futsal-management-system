                ...
                <div class="m-widget24">
                    <div class="m-widget24__item">
                        ...
                        <div class="progress m--bg-info m-progress--sm">
                            <?php
                            $width=0;
                            if($report['certificates']['total']>0)
                ...
                <div class="m-widget24">
                    <div class="m-widget24__item">
                        ...
                        <div class="progress progress-cyan-bg m-progress--sm">
                            <?php
                            $width=0;
                            if($report['total_invoice']['total']>0)
